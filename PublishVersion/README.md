# Description:
This mod adds an RPG-like system of levels and attribute increases: - Wacky Branch 1.7.4
...
<details><summary>Mob Data Included</summary>
	...
	Latest Update for Jsons config is <b> 1.7.4 </b>(Number will be updated when Jsons recieve an update)
...
| Version | Changes                                                                                                                                                                                                                                                                                                                                |
|----------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1.7.4  | - Updated Monstrum and Monsterlabz, add localization for tooltip and orb power. <br/> Added Speed Manager by Blaxx for compability. <br/> Added Portuguese
