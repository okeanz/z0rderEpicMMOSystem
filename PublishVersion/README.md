...
| Version | Changes                                                                                                                                                                                                                                                                                                                                |
|----------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1.5.6  | - Added German Localization <br /> Changed Defaults to not take any drops away, no mattter the level. - Blax complained enough - <br /> Stamina Regen is a Percentage <br />
