# Description:
This mod adds an RPG-like system of levels and attribute increases: - Wacky Branch 1.5.6
...
| Version | Changes                                                                                                                                                                                                                                                                                                                                |
|----------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1.5.6  | - Added German Localization <br /> Changed Defaults to not take any drops away, no mattter the level. - Blax complained enough - <br /> Stamina Regen is a Percentage <br /> Added MOB UI string for wacky fun, aka single char words languages <br /> Update ItemManager <br /> Added ability to set "none" on color for all hud elements to make them go away, should live update. Might have relauch to get them to come back
